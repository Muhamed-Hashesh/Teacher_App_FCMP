...
class QuestionCardLiveExam extends StatefulWidget {
  ...
  const QuestionCardLiveExam({
    ...
    required this.questions, // Initialize it here as well
  });
...
class _QuestionCardLiveExamState extends State<QuestionCardLiveExam> {
  ...
  void initState() {
    super.initState();
    // Initialize the selected options list with `null` for each question
  ...
  Widget build(BuildContext context) {
    ...
    int? _selectedOptionIndex = _selectedOptions[_currentIndex];
